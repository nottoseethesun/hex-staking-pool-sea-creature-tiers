 ...
 * oa_flag); oa_wallets.csv is the evidence-backed OA cluster. OA-cluster stakers
 ...
 * @returns {string}
 */
function leaguesCsv(view, contractFlags) {
  const header =
    "rank,address,tshares,pct_of_nonoa_pool,percentile,league,is_contract,oa_flag";
  const rows = [header];
